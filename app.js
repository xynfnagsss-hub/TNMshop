/**
 * TNM (TRUST NO MOB) OFFICIAL MARKETPLACE
...
const MARKET_ITEMS = [
  ...
  },
  {
    ...
    desc: 'The pinnacle of leadership in Trust No Mob. Highest obtainable command rank.',
  ...
  resultBox.innerHTML = `
    <div style="display: flex; align-items: center; gap: 12px;">
      ...
      <div>
        ...
        <span style="color: #57f287; font-size: 0.8rem; font-weight: 700;"><i class="fa-solid fa-circle-check"></i> Group Member (Rank: Trust No Mob Active)</span>
      </div>
    </div>
  `;
}
